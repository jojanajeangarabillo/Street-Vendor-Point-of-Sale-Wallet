            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">0.00 XLM</div>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Completed (Today)</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">0</div>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-lg-8">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo URLROOT; ?>/transaction" class="btn btn-sm btn-primary">View All</a>
            </div>
            <div class="card-body">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    <a href="<?php echo URLROOT; ?>/payment/create" class="btn btn-primary">
                        <i class="bi bi-plus-circle me-2"></i> Create New Payment
                    </a>
                    <a href="<?php echo URLROOT; ?>/payment/monitor" class="btn btn-outline-info">
                        <i class="bi bi-display me-2"></i> Monitor Live Payments
                    </a>
                    <a href="<?php echo URLROOT; ?>/wallet" class="btn btn-outline-secondary">
